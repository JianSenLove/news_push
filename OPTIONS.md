...
> **⚠ Agent 注意事项 (Agent Context Scope) ⚠**
> 本文件**仅作索引**，**绝对禁止**在此文件中直接添加长篇大论的实现细节和架构设计。
> 详情必须参考 `docs/features/` 目录下的独立 Markdown 文档。如果你是新唤醒的 Agent，请优先阅读 `.agent/skills/project-onboarding/SKILL.md`。
